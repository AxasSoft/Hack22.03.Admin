<template>
    ...
    <VTabs v-model="tab" class="w-100 bg-clear ma-5 mb-0">
        <VTab selected-class="selected-item" base-color="var(--gray-text)" value="white">WhiteList</VTab>
        <VTab selected-class="selected-item" base-color="var(--gray-text)" value="black">BlackList</VTab>
    </VTabs>
    ...
    <VCard class="ml-5 container d-flex flex-column">
        ...
        <div class="header d-flex align-center justify-center v-align-center">
            <h2 class="ma-4">Черный и белый списки пользователей</h2>
...
import AddInfoSidebar from './AddW&BSidebar.vue';
import InfoItem from './W&BItem.vue';
import hint from '@/assets/images/CatalogHint@3x.png'
import type { FAQ } from '@/types/FAQ';
import InfoSidebar from './W&BSidebar.vue';
